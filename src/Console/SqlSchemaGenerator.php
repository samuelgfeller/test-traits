...
/**
 * Generates schema.sql with current MySQL database table.
 *
...
final readonly class SqlSchemaGenerator
{
    ...
    /**
     * Generates MySQL schema.sql with the current database.
     * Used by the command line.
     *
     * @return int
     */
    public function generateMySqlSchema(): int
    {
        ...
        $filename = $this->schemaOutputPath . '/schema.sql';
